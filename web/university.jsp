...
<html>
    ...
    <body>
        <h1><center><font color="black">Our Past Records Of Placement</font></center></h1>
        <div>
            <div class=container">
        ...
        <%
            try{
                ...
                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3307/sys","root","dhruval");
                String s = "select * from placement";
